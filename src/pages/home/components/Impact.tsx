...
export default function Impact() {
  const stats = [
    { number: '3+ Million', label: 'End Users Reached', icon: 'ri-speed-up-line' },
    { number: '300+ hours saved / week', label: 'Operational Improvements Made', icon: 'ri-shield-check-line' },
    { number: '4', label: 'Enterprise Projects Delivered', icon: 'ri-rocket-line' }
  ];
          ...
          <div className="space-y-4 md:space-y-8">
            ...
            <div className="relative">
              ...
              <blockquote className="text-xl md:text-4xl font-serif text-white leading-relaxed pl-4 md:pl-8">
                Delivered finished AI solutions to customers in as little as 4.5 months.
              </blockquote>
            </div>
            ...
            <div className="flex items-center gap-3 md:gap-4 pl-4 md:pl-8">
              ...
              />
              <div>
                <p className="font-bold text-white text-sm md:text-base">Helena Willits</p>
                <div className="flex items-center gap-1 md:gap-2">
                  <span className="text-xs md:text-sm text-gray-400">Software Developer</span>
